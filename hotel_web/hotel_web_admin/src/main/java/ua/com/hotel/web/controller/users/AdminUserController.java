package ua.com.hotel.web.controller.users;
...
import ua.com.hotel.web.validator.AdminUserValidator;
...
public class AdminUserController {
    ...
    private static final String PAGE_USER_LIST_ADMIN = "/admin/users/userList";
    private static final String PAGE_USER_ADMIN = "/admin/users/user";
    private static final String PAGE_USER_ADMIN_SUCCESS = "/admin/users/userSuccess";
