...
<layout:layout>
    ...
    <div class="room-find">
        ...
        <div class="room-find-header text-center">

            <h1 class="page-name">
                <spring:message code="finding.rooms"/>
            </h1>

            <p class="lead">
                This is page provided information about finding room
            </p>

        </div>

        <div class="room-find-body">
						 ...
						 <table class="table table-striped table-bordered table-hover">
							 <thead>
								 <tr role="row">
									 ...
									 <th class="sorting_desc" style="width: 188px;">
							 ...
							 <tbody>
							 <c:forEach var="room" items="${findingRooms}">
								 <tr class="gradeC odd" role="row">
									 ...
									 <td class="center">
										 <a href="/manager/bookingRequestProcess/makeOrder?roomId=${room.id}&bookingRequestId=${bookingRequestId}">
											<button class="btn btn-sm btn-info" style="padding:4px 9px;">
